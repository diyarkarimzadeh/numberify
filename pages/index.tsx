  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name='description' content='Get a Temp Number; Fast, Secure, Low Cost' />
      ...
      <section className='container flex justify-center flex-col items-center gap-6 pt-6 pb-8 md:py-10'>
        <div className='flex max-w-[980px] flex-col items-center gap-2'>
          ...
          <p className='max-w-[700px] text-center text-lg text-slate-700 dark:text-slate-400 sm:text-xl'>
            We offer Temp Numbers for most popular services which you can get one easily and use them without any need
      ...
      <section className={styles.features}>
        <div className={styles.features_item}>
          ...
          <p>
            Getting a temp number takes less than 5 minutes. <br className='hidden sm:inline' />
            Without any bullsh*t signup
          </p>
        </div>
        <div className={styles.features_item}>
          <Icons.shield />
          ...
          <p>
            It's not secure to use your real phone number <br className='hidden sm:inline' /> for services you use so a
            temp number is a <br className='hidden sm:inline' />
            more secure option
          </p>
        </div>
        <div className={styles.features_item}>
          ...
          <p>
            It's very cheap to get a temp number, <br className='hidden sm:inline' /> Prices are diffrent base on
            service or location <br className='hidden sm:inline' /> but usually it's $2 to $7 range
          </p>
        </div>
      </section>
    </Layout>
